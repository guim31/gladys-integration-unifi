...
1. Rendez-vous sur votre console UniFi dans le menu **Integrations** (ex: `https://192.168.100.1/network/default/integrations` ou *UniFi Network > Control Plane / Settings > Integrations*).
...
2. Allez dans **Admins / Utilisateurs (👥)** (ou dans *Control Plane / Identity > Admins*).
